...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException {
        ...
        InputStream ism = new FileInputStream("/Users/sbhuiyan/AllMyPntWorkFiles/programs/IdeaProjects/Bootcamp_WeekDays_Selenium_December2019/Generic/src/main/secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
